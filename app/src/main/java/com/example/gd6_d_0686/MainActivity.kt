package com.example.gd6_d_0686
...
import com.example.gd6_d_0686.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun sendNotification1() {
        ...
        val builder = NotificationCompat.Builder(this, CHANNEL_ID_1)
            ...
            .setContentTitle(binding?.etMessage?.text.toString())
        ...
        with(NotificationManagerCompat.from(this)) {
            notify(notivication1, builder.build())
        }
    }
